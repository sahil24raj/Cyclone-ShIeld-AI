...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    app_title: 'CycloneShield AI',
    tagline: 'Predict. Protect. Respond.',
    prototype_badge: 'PROTOTYPE SIMULATION',
    disclaimer: 'This prototype is for decision support and does not replace official IMD/NDMA warnings.',
  ...
  hi: {
    app_title: 'साइक्लोनशील्ड एआई',
    tagline: 'पूर्वानुमान। सुरक्षा। प्रतिक्रिया।',
    prototype_badge: 'प्रोटोटाइप सिमुलेशन',
    disclaimer: 'यह प्रोटोटाइप निर्णय समर्थन के लिए है और आधिकारिक IMD/NDMA चेतावनियों का स्थान नहीं लेता है।',
    ...
    ai_briefing: 'एआई ब्रीफिंग',
    alert_centre: 'अलर्ट सेंटर',
